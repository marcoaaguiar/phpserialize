...
Reference = namedtuple("Reference", ["position"])
...
def load(
    ...
    def _unserialize():
        ...
        if type_ == b"r":
            _expect(b":")
            return Reference(int(_read_until(b";")))
